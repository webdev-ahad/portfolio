      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-2.5">
        ...
        >
          <span className="inline-flex h-12 w-20 items-center justify-center">
            <img src={portfolio.logo} alt={portfolio.name} className="h-20 w-20 object-contain" />
          </span>
        </NavLink>
        ...
        <div className="flex items-center gap-2">
          <NavLink
            to={routes.contact}
            className="hidden rounded-xl bg-white px-4 py-2 text-sm font-semibold text-slate-950 transition duration-300 hover:bg-slate-100 md:inline-flex"
          >
            Let’s talk
          </NavLink>
